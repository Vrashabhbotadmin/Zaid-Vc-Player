...
BOT_TOKEN = getenv("BOT_TOKEN", "5454352993:AAEbK8E8oVDGTeJj8VLqqLAmSc7rDvqOXFA")
BOT_NAME = getenv("BOT_NAME", "Vivi-music")

API_ID = int(getenv("API_ID", "21169898"))
API_HASH = getenv("API_HASH", "3bf3977ac2afcbefee5460e38c38135a")
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://Cloner:Cloner@cluster0.cgc6t.mongodb.net/?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "vivibot")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Musicbot65v")
ALIVE_NAME = getenv("ALIVE_NAME", "vivi")
BOT_USERNAME = getenv("BOT_USERNAME", "Officimusic_bot")
OWNER_ID = getenv("OWNER_ID", "5682847277")
